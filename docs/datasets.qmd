...
Metadata is provided alongside each dataset and includes:
...
Students are encouraged to consult the metadata before working with the datasets, as it provides essential context for interpretation and analysis.
...
If you have questions about accessing or interpreting the data, please get in touch with the training team.
